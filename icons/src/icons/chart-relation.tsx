...
export default (props: P.IconProps) => (
  <P.SvgIcon data--icon-name="chart-relation" {...props} viewBox="0 0 32 32">
    <path
    ...
    />
    <path
      d="M19.6538 13.0769C19.6538 16.7093 16.7093 19.6538 13.0769 19.6538C9.44459 19.6538 6.5 16.7093 6.5 13.0769C6.5 9.44459 9.44459 6.5 13.0769 6.5C16.7093 6.5 19.6538 9.44459 19.6538 13.0769Z"
      stroke="currentColor"
    />
  </P.SvgIcon>
);
