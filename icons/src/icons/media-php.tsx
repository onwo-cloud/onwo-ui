...
export default (props: P.IconProps) => (
  <P.SvgIcon data--icon-name="media-php" {...props} viewBox="0 0 32 32">
    <path
    ...
    />
    <path
      d="M14.1633 16V20M14.3173 18H17.438M17.498 16V20M10 20V16H11.5013C12.3527 16 12.7213 16.568 12.7213 17.0793C12.7213 17.5907 12.3527 18.1587 11.5013 18.1587H10M19.2787 20V16H20.78C21.6307 16 22 16.568 22 17.0793C22 17.5907 21.6313 18.1587 20.78 18.1587H19.2787"
      stroke="currentColor"
