...
export default (props: P.IconProps) => (
  <P.SvgIcon data--icon-name="media-html" {...props} viewBox="0 0 32 32">
    <path
    ...
    />
    <path
      d="M20.821 15.938V18.9904H22.6886M19.3012 18.9904V15.938L17.8201 17.9191L16.3391 15.938V18.9904M9.28857 15.938V18.9904M9.28857 17.4H11.5722M11.5722 15.938V18.9904M13.8855 18.9904V16.0071M14.9906 15.938H12.7803"
      stroke="currentColor"
