...
export default (props: P.IconProps) => (
  <P.SvgIcon data--icon-name="files-generic" {...props} viewBox="0 0 32 32">
    <path
    ...
    <line
      ...
      x2="4.65134"
      y2="-0.5"
      transform="matrix(0.70516 0.709048 -0.70516 0.709048 21.2727 8.96362)"
      stroke="currentColor"
    />
    <path
      d="M17.9369 7H14.5C10.7288 7 8.84315 7 7.67157 8.17157C6.5 9.34315 6.5 11.2288 6.5 15V18C6.5 21.7712 6.5 23.6569 7.67157 24.8284C8.84315 26 10.7288 26 14.5 26H17.3958C21.167 26 23.0527 26 24.2242 24.8284C25.3958 23.6569 25.3958 21.7712 25.3958 18V16"
      stroke="currentColor"
