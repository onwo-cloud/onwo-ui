...
export default (props: IconProps) => (
  <SvgIcon data--icon-name="media-js" {...props} viewBox="0 0 32 32">
    <path
    ...
    />
    <path
      d="M12 19.5427C12.3851 20.0074 12.8954 20.4 13.5521 20.4C14.055 20.4 14.8466 20.0574 14.8466 18.8596V15.4H14.0138M19.5192 15.5736C18.1121 15.1338 17.1372 15.5699 17.1372 16.4412C17.1372 17.9221 20 17.7088 20 19.1478C20 20.425 18.3551 20.6743 16.9046 19.8368"
      stroke="currentColor"
