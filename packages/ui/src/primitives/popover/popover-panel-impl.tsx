...
export const HPopoverPanelImpl = component$((props: PropsOf<'div'>) => {
  ...
  useTask$(async ({ track, cleanup }) => {
    ...
    if (!polyfillContainer) {
      ...
      polyfillContainer.dataset.qwikUiPopoverPolyfill = '';
      document.body.append(polyfillContainer);
    }
    ...
    if (context.panelRef?.value) {
      ...
      if (topLayerAncestor === null) {
        polyfillContainer.append(context.panelRef.value);
      } else {
      ...
      onToggle$={[
        $((e: CorrectedToggleEvent) => {
          ...
          if (
            ...
            context.panelRef.value.parentElement.append(context.panelRef.value);
          }
        }),
        props.onToggle$,
      ]}
