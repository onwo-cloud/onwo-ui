...
import { Previous as PPrevious } from '@onwo/primitives/carousel';
import type { IconProps } from '@onwo/primitives/svg-icon';

type PreviousProps = PropsOf<typeof PPrevious> & {
  icon?: (props: IconProps) => JSXOutput;
};

export const Previous = ({ icon: Icon = ChevronLeftIcon, ...props }: PreviousProps) => (
  <PPrevious
    {...props}
