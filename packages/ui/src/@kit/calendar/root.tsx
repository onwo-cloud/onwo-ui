...
import type { OneObjectOf } from '~ui/utils/types';
          ...
          {(showClearButton || showTodayButton) && (
            <div class="mt-2 flex space-x-2">
              {showTodayButton && (
                <button
                  type="button"
                  class="w-full rounded-lg px-5 py-2 text-center text-sm font-medium focus:ring-4 focus:ring-blue-300"
                  onClick$={$(() => {
              ...
              {showClearButton && (
                <button
                  type="button"
                  class="w-full rounded-lg px-5 py-2 text-center text-sm font-medium focus:ring-4 focus:ring-blue-300 border border-line"
                  onClick$={() => {
                    changeSelectedDate$();
                  }}
                >
