...
export type HToggleGroupProps = PropsOf<'div'> & ToggleGroupApiProps;

export const HToggleGroup = component$<HToggleGroupProps>((props) => {
  useStyles$(styles);
  const {
    onChange$: _,
    disabled = false,
  ...
  */
  ...
  return (
    <div {...divProps} {...commonProps} data-qui-togglegroup-root data-orientation={orientation}>
      <Slot />
    </div>
  );
});
