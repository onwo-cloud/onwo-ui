...
export default (props: P.IconProps) => (
  <P.SvgIcon data--icon-name="media-zip" {...props} viewBox="0 0 32 32">
    <path
    ...
    />
    <path
      d="M18.4335 20.4V16M18.4335 18.4509H20.1249C21.0841 18.4509 21.5 17.8061 21.5 17.2258C21.5 16.6456 21.0841 16.0007 20.1249 16.0007H18.4335M15.9308 16V20.4M10.6425 16.0007L13.5222 16L10.5 20.323H13.5713"
      stroke="currentColor"
