  ...
  return (
    <div class="w-full max-w-4xl mx-auto p-6 bg-white border border-gray-200 rounded-lg">
      ...
      <div class="flex justify-between items-start mb-6">
        <div>
          <h2 class="text-blue-500 text-sm mb-1">Net Worth</h2>
          <div class="text-3xl font-bold text-blue-900">$382,542.79</div>
          <div class="text-sm mt-1">
            <span class="text-green-500">$76,902.88 (↑ 25.2%)</span>
            <span class="text-blue-500"> vs. last month</span>
          </div>
        </div>
      ...
      <div class="relative" ref={containerRef}>
        ...
        {_hoveredPoint.value && _showPopover.value && !_isAnimating.value && (
          ...
          >
            ...
            <div class="text-xs text-blue-300 mt-1">
              ...
              {_hoveredPoint.value.isInterpolated && <span class="ml-1 text-blue-400">~</span>}
            </div>
            {/* Arrow pointing down */}
        ...
        {/* Date labels */}
        <div class="flex justify-between mt-4 text-xs text-blue-500">
