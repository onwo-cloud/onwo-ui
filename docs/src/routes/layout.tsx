...
//  return (
//    <div>
//      <div role="main" class="pt-16 lg:pt-0 bg-parchment text-ink-primary flex theme-onwo-light" dir="ltr">
//        <div
//          id="left-menu"
...
//
//          <div class="fixed bg-parchment text-ink-primary shadow-onwo-none inset-y-0 w-80 max-w-md left-0 onwo-panel">
//            <nav
//              aria-label="Sidebar"
//              class="z-10 fixed top-0 h-screen w-80 flex flex-col flex-grow gap-4 pt-8 pb-10 px-5 lg:px-8 overflow-y-scroll"
//            >
//              <div class="flex items-center flex-shrink-0 px-3 text-ink-primary">
