    ...
    <Showcase
      ...
      component={
        <div class="flex gap-4 items-center justify-around">
          <Button size="xs" start={Icon.named('settings')}>
            Size XS
          </Button>
          <Button size="sm" start={Icon.named('settings')}>
            Size SM
          </Button>
          <Button size="md" start={Icon.named('settings')}>
            Size MD
          </Button>
          <Button size="lg" start={Icon.named('settings')}>
            Size LG
          </Button>
          <Button size="xl" start={Icon.named('settings')}>
            Size XL
          </Button>
        </div>
      }
      code={`<Button size="xs" start={GenericIcon.named('settings')}>Size XS</Button>
    ...
    <Showcase
      ...
      component={
        <div class="flex gap-4 items-center justify-around">
          ...
          <Button size="md" end={Icon.named('settings')}>
            Button end
          </Button>
        </div>
      }
      code={`<Button size="md" start={GenericIcon.named('settings')}>Button start</Button>
<Button size="md" end={GenericIcon.named('settings')}>Button end</Button>`}
    />
    ...
    <Showcase
      ...
      component={
        <div class="flex gap-4 items-center justify-around">
          <Button size="md" variant="outline" end={(_: BaseIconProps) => <b>🚀</b>}>
            Custom
          </Button>
        </div>
      }
