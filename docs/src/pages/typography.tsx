        ...
        <div class="flex flex-row items-center justify-between">
          <div class="flex flex-row gap-2 w-full">
            ...
            >
              ...
              <div
                class="flex p-1 bg-gohan items-center rounded-moon-s-md gap-1 order-2 w-fit justify-left"
                role="tablist"
            ...
            >
              ...
              <div role="tabpanel" tabIndex={0} class="order-4 w-full focus:outline-none">
                <div class="flex p-4 bg-gohan rounded-moon-s-sm text-moon-14 w-full">
                  <div class="flex flex-wrap items-center justify-around gap-2 w-full bg-transparent">
                    <div class="flex flex-col gap-2 w-full">
                      <span class="text-moon-9-caption uppercase transition-colors">Size 9</span>
                      <span class="text-moon-10-caption uppercase transition-colors">Size 10</span>
                    </div>
                  </div>
                </div>
              </div>
