  ...
  <div class="flex flex-col grow max-w-screen-xl">
    ...
    <div class="flex flex-col gap-12 flex-1 relative focus:outline-none">
      ...
      <section class="flex flex-col">
        <div class="flex flex-row items-center justify-between">
          <div class="flex flex-row gap-2 w-full">
            <div id="text_1-example-and-code" class="flex items-center justify-between flex-wrap gap-6 w-full">

              <h2 class="text-moon-24 font-semibold order-1">Text</h2>




              <div class="flex p-1 bg-gohan items-center rounded-moon-s-md gap-1 order-2 w-fit justify-left" role="tablist" aria-orientation="horizontal">
      ...
      <section class="flex flex-col">
        <div class="flex flex-row items-center justify-between">
          <div class="flex flex-row gap-2 w-full">
            <div id="text_2-example-and-code" class="flex items-center justify-between flex-wrap gap-6 w-full">

              <h2 class="text-moon-24 font-semibold order-1">Heading</h2>
      ...
      <section class="flex flex-col">
        <div class="flex flex-row items-center justify-between">
          <div class="flex flex-row gap-2 w-full">
            <div id="text_3-example-and-code" class="flex items-center justify-between flex-wrap gap-6 w-full">

              <h2 class="text-moon-24 font-semibold order-1">Caption</h2>
      ...
      <section class="flex flex-col">
        <div class="flex flex-row items-center justify-between">
          <div class="flex flex-row gap-2 w-full">
            <div id="text_4-example-and-code" class="flex items-center justify-between flex-wrap gap-6 w-full">

              <h2 class="text-moon-24 font-semibold order-1">Custom Colours</h2>
