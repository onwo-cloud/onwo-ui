...
export const Pill = <Name extends string>({ class: className, ...props }: PillProps<Name>) => (
  <Tabs.Tab
    class={cn(
      'relative flex text-bulma cursor-pointer transition-colors items-center justify-center font-semibold rounded-onwo-i-sm gap-1 focus:outline-none data-selected:bg-goku text-onwo-14 hover:bg-goku',
      /* disabled */
